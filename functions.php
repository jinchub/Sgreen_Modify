...
$form->addInput($css->multiMode());
	...
	$Abstract= new Typecho_Widget_Helper_Form_Element_Radio('Abstract',
        ...
        'able', _t('是否启用自动摘要'), _t('默认禁止，默认显示全文，在发布文章时请使用“摘要分割线”工具；启用则自动获取摘要'));
	...
	$search= new Typecho_Widget_Helper_Form_Element_Radio('search',
        ...
        'able', _t('是否启用搜索功能'), _t('默认禁止，启用则会在头部添加搜索框'));
    ...
    $logoUrl = new Typecho_Widget_Helper_Form_Element_Text('logoUrl', NULL, NULL, _t('你的头像地址【替换主题目录下面的头像文件即可, 头像目录为/Sgreen_Modify/img/logo/】<br> green目录中为正常头像<br>black目录中为暗黑模式的头像'), _t('头像地址框不用填写，请使用文件替换头像目录中头像文件，文件名称为logo.png'));
