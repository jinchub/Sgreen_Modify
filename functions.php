...
$form->addInput($css->multiMode());
    ...
    $twlink = new Typecho_Widget_Helper_Form_Element_Text('twlink', NULL, NULL, _t('你的twitter地址'), _t('在这里填入你的twitter地址'));
    $form->addInput($twlink);
    ...
    $wechat = new Typecho_Widget_Helper_Form_Element_Text('wechat', NULL, NULL, _t('你的微信收款码'), _t('在这里填入你的微信打赏收款码图片链接，默认显示在打赏按钮下方'));
    $form->addInput($wechat);

    $zhifubao = new Typecho_Widget_Helper_Form_Element_Text('zhifubao', NULL, NULL, _t('你的支付宝收款码'), _t('在这里填入你的支付宝打赏收款码图片链接，默认显示在打赏按钮下方'));
